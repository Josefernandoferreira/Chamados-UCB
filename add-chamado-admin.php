				...
				<div class="col-sm-6">
					...
					<form method="post">
						...
						<div class="form-group">
							...
							<input type="hidden" name="atendente" id="atendente" class="form-control" value=<?php echo $_SESSION['usuario'];?> required>

						</div>
						
						<div class="form-group">

							<label>Status: <font color ="#007bff"><b>Registrando Atendimento</b></font></label>

							<input type="hidden" name="status" id="status" class="form-control" value="Concluído" required>
						...
						<div class="form-group">
							...
							<input type="text" name="username" id="username" class="form-control" placeholder="Infome seu nome" required>
						...
						<div class="form-group">
							...
							<select class="tel form-control" name="modalidade" id="modalidade" x-autocompletetype="tel" placeholder="Selecione a modalidade" required>
						...
						<div class="form-group">
							...
							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-check"></i> Registrar Chamado</button>
