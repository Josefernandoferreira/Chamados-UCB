...
<body style="background:#eee;">
	...
	$condition	='AND status LIKE "Concluído"';
	...
	?>
   	<div class="container">
		<hr>
		<h1>NTE - Solicitações Concluídas | <a href="logout.php">Sair</a> | <a href="grafico.php">Dashboard</a></h1>
		<hr>	
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-user"></i> <strong> <?php echo $_SESSION['usuario'];?></strong> <a href="add-chamado-admin.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Registrar Chamado</a></div>
						...
						<div class="row">
							...
							<div class="col-sm-2">
								<div class="form-group">
									<label>&nbsp;</label>
									<div>
										 <a href="browse-users.php" class="btn btn-dark"><i class="fa fa-fw fa-exclamation-triangle"></i> Pendentes</a>
									</div>
								</div>
							</div>
			...
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center"><?php echo date('d-m-Y',strtotime($val['df_final']));?></td>
						<td><?php echo $val['categoria'];?></td>
						<td align="center">
						<a href="viewer_admin.php?editId=<?php echo $val['id'];?>" class="text-primary"><i class="fa fa-fw fa-edit"></i> Ver Solicitação</a>
					...
					?>
					<tr><td colspan="6" align="center">Nada a ser mostrado!</td></tr>
					<?php } ?>
				</tbody>
			</table>
		</div> <!--/.col-sm-12-->
